package gtap.commands 
{
	...
	public class SerialCommand extends Command
	{
		...
		override final protected function execute():void
		{
			...
			_commands[0].signal.addOnce(onSubcommandComplete);
			
			//...and start the subcommand
			_commands[0].start();
		}
		
		private function onSubcommandComplete(e:Event, obj:*= null):void
		{
			...
			if (_completeCommandCount == _commands.length) {
				...
				_commands[_completeCommandCount].signal.addOnce(onSubcommandComplete);
